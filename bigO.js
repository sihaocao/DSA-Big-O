...
// Question 8) The Big O is O(log n). This algorithm attempts to find the index of the item in a sorted array.
// It first separates the sorted array in half and have the pointers narrow down the list of possible values by halvening the array each time.
// The search ends when the pointers are pointing at the index of the item.
...
// Time Complexity: Exponential Time Complexity O(n), running time directly proportional to size of input
...
// Time Complexity: Exponential Time Complexity O(n), running time directly proporational to size of input
...
// Time Complexity: Logarithmic Time Complexity O(n), running time directly proportional to size of input
